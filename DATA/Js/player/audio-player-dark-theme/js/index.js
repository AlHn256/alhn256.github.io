var Framer = {
  ...
  drawTick: function (x1, y1, x2, y2) {
    ...
    gradient.addColorStop(0, '#8E3830');
    gradient.addColorStop(0.6, '#8E3830');
    gradient.addColorStop(1, '#8E3830');
    this.context.beginPath();
  ...
  drawEdging: function () {
    this.context.save();
    this.context.beginPath();
    this.context.strokeStyle = 'rgba(142, 56, 48, 1)';
    this.context.lineWidth = 1;
...
var Scene = {
  ...
  canvasConfigure: function () {
    ...
    this.context.strokeStyle = '#8E3830';
    this.calculateSize();
  },
...
var Controls = {
  ...
  drawPic: function () {
    this.context.save();
    this.context.beginPath();
    this.context.fillStyle = 'rgba(142, 56, 48, 1)';
    this.context.lineWidth = 1;
